            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('admin.Demo') }}">All Course Forms</a></li>
            ...
            <div class="row">
                <div class="col-xl-12 col-xxl-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="addDemo" action="{{route('admin.Demoupdate',$Demo->id) }}"
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="demo_name"
                                                value="{{ $Demo->demo_name }}" id="demo_name"
                                                class="form-control">
                                        </div>
                                    </div>
