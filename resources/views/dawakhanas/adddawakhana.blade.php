            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0);">Add Dawakhana</a></li>
                    </ol>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12 col-xxl-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="addDawakhana" action="{{ route('admin.dawakhanastore') }}" method="POST">
                                {{ csrf_field() }}
                                <div class="row">
