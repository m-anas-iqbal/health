          ...
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
              ...
              ?>
                ...
                <a href="{{url('frontpharmacy/inventory/addBrand')}}" class="btn btn-primary">Add Brand</a>     
                <!-- Tab panes -->
                      ...
                      <table class="table table-hover">
                         ...
                         <tbody>
                            <?php 
                                 ...
                                 $brands = DB::table('brand')->where('pharmacy_id', $pharmacy_id)->get();
                            ?>
                           @if($brands)
                              @foreach($brands as $brand)
                                 <tr>
                                    ...
                                    <td>@if($brand->status == 1) Active @elseif($brand->status == 0) Inactive @endif</td>
                                    <td><a class="btn btn-success btn-xs" href="{{url('frontpharmacy/inventory/editBrand/'.$brand->id)}}">Edit</a></td>
                                 </tr>
                              @endforeach   
                           @endif
                         </tbody>
