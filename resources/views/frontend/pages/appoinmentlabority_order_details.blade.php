          ...
          <!-- main content -->
            <div class="main-content col-lg-12">
              <div id="content" role="main" style='padding:30px;'>
                      <div class='row'>
                          <div class='col-sm-2'><b>Labority Full Name:</b></div>
                          ...
                          <div class='col-sm-2'><b>Labority's Location:</b></div>
                          <div class='col-sm-4'>{{$order->maddress}}</div>
                      </div>
                      <br>  
                      <div class='row'>
                          <div class='col-sm-2'><b>Labority's Comments:</b></div>
                    ...
                    <div class="row">
                      ...
                      <span id='dcomments_msg' style='color:green;'></span>
                        ...
                        <button id='dcomments_btn'>Save Labority Comments</button>
                      </div>
                  </div>
                  @endif
              </div>
