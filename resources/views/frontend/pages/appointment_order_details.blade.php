          ...
          <!-- main content -->
            <div class="main-content col-lg-12">
              <div id="content" role="main" style='padding:30px;'>
                      <div class='row'>
                          <div class='col-sm-2'><b>Patient Full Name:</b></div>
                          <div class='col-sm-4'>{{$order->patient_fullname}}</div>

                          <div class='col-sm-2'><b>Docotor Name: </b></div>
                          <div class='col-sm-4'>{{$order->doctor_fullname}}</div>

                          <div class='col-sm-2'><b>Specialization:</b></div>
                          <div class='col-sm-4'>{{$order->title}}</div>

                          <div class='col-sm-2'><b>Appointment:</b></div>
                          <?php 
                              //$order->day
                              switch($order->day){
                          ...
                          <div class='col-sm-2'><b>Doctor's Location:</b></div>
                    ...
                    @if(Auth::guard('frontdoctor')->user())  
                      <br>  
                    <div class="row">
                      <div class='col-sm-2'><b>Doctor's Comments::</b></div>
                      ...
                      <span id='dcomments_msg' style='color:green;'></span>
                        ...
                        <button id='dcomments_btn'>Save Doctor Comments</button>
                      </div>
                  </div>
...
<script>
  $(document).on('click', '#dcomments_btn', function(){
      ...
      $.ajax({
        type:'post',
        url:"{{url('frontdoctor/updateDoctorComments')}}",
        data:{order_id:order_id,dcomments:dcomments,_token: "{{ csrf_token() }}"},
        dataType:'JSON',
        success:function(data){
          //console.log('success doctors comments');
          //console.log(data);
