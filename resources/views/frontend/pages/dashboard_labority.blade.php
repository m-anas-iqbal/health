      ...
      <div class="container">
        ...
        <div class="section-content">
          <div class="row">
            ...
            ?>
            <h1>Laboratory Name: <span class="title text-white">{{$patient_fullname}}</span></h1>
            <h1>Laboratory Phone: <span class="title text-white">{{$patient_phone}}</span></h1>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
              ...
              <?php 
                     if( Auth::guard('frontlabority')->user() ){
                        ...
                        $patientOrdersExist = DB::table('order_laborities as od')
                                                ->join('patients as p', 'od.patient_id', 'p.id')
                                                ->join('laborities as do', 'do.id', 'od.labority_id')
                                                ->where('od.labority_id', $patient_id)->get();
              ...
              ?>
                ...
                <ul class="nav nav-tabs" role="tablist">
                  <li role="presentation" class="active">
                     <a href="#orders" aria-controls="orders" role="tab" data-toggle="tab" class="font-15 text-uppercase" aria-expanded="false">Upcomming Lab Test <span class="badge"></span></a>
                  </li>
                           ...
                           @if($p_orders)
                              @foreach($p_orders as $order)
                                 <tr>
                                    ...
                                    <td>{{$order->fees}}</td>
                                    <td><a class="btn btn-success btn-xs" href="{{url('frontlabority/appointmentlabority_order_details/'.$order->order_id)}}">View Order</a></td>
                                 </tr>
                              @endforeach   
                           @endif
                         </tbody>
