...
@section('content')
  ...
  <div class="main-content" style="margin:0 auto;width:75%;">
	...
	<div class="section-header heading_style4 center">
            <h2>Edit Doctor Registration</h2>
          </div>
...
<form id="addDoctor" action="{{ url('frontdoctor/editDoctorRegistrationProcess') }}" method="POST"
    ...
    <div class="row">
            <div class="col-sm-6">
                ...
                <label>Full Name</label><span id='doctor_fullname'></span>
                  <input type="text" name="doctor_fullname" id="doctor_fullname" value="{{ $doctors->doctor_fullname }}" placeholder="Full Name" class="form-control chk-empty">
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                    <label class="form-label">Email</label> <span id='email'></span>
                    <input type="email" name="email" value="{{ $doctors->email }}" id="email" class="form-control">
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                        <label class="form-label">Phone</label> <span id='doctor_phone'></span>
                        <input type="number" name="doctor_phone" value="{{ $doctors->doctor_phone }}" id="doctor_phone"
                                                class="form-control">
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input type="date" name="doctor_dob" value="{{ $doctors->doctor_dob }}" id="doctor_dob" class="form-control">
                </div>
              </div>
            ...
            <div class="col-lg-6">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input type="text" name="doctor_degree" value="{{ $doctors->doctor_degree }}" class="form-control">
                </div>
              </div>
              ...
              <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input type="text" name="doctor_experience" value="{{ $doctors->doctor_experience }}" class="form-control">
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
            ...
            <div class="col-sm-6">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input type="text" name="doctor_country" value="{{ $doctors->doctor_country }}" class="form-control">
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input type="text" name="doctor_address" value="{{ $doctors->doctor_address }}" class="form-control">
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                    <label class="form-label">Fees</label> <span id='doctor_fees'></span>
                    <input type="text" name="doctor_fees" value="{{ $doctors->doctor_fees }}" class="form-control">
                </div>
              </div>
              <div class="col-sm-12">
                <div class="form-group">
