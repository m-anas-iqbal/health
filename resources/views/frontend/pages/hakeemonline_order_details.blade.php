            ...
            <div class="main-content col-lg-12">
              <div id="content" role="main" style='padding:30px;'>
                      <div class='row'>
                          ...
                          <div class='col-sm-2'><b>Hakeem Name: </b></div>
                          <div class='col-sm-4'>{{$order->hakeem_fullname}}</div>
                          ...
                          <div class='col-sm-2'><b>Hakeem's Location:</b></div>
                    ...
                    @if(Auth::guard('fronthakeem')->user())  
                      <br>  
                    <div class="row">
                      <div class='col-sm-2'><b>Hakeem's Comments::</b></div>
                      ...
                      <span id='dcomments_msg' style='color:green;'></span>
                        ...
                        <button id='dcomments_btn'>Save Hakeem Comments</button>
                      </div>
                    </div>
...
<script>
  $(document).on('click', '#dcomments_btn', function(){
      ...
      $.ajax({
        type:'post',
        url:"{{url('fronthakeem/updateHakeemComments')}}",
        data:{order_id:order_id,dcomments:dcomments,_token: "{{ csrf_token() }}"},
        dataType:'JSON',
        success:function(data){
          //console.log('success hakeems comments');
          //console.log(data);
