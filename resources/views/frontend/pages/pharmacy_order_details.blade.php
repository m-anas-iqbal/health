            ...
            <div class="main-content col-lg-12">
              <div id="content" role="main" style='padding:30px;'>
                      <div class='row'>
                          ...
                          <div class='col-sm-4'>{{$order->pharmacy_fullname}}</div>
                      ...
                      <br>  
                      <div class='row'>
                          <div class='col-sm-2'><b>Comments:</b></div>
                          <div class='col-sm-10'>{{$order->comments}}</div>
                      </div>

                      <br>  
                      <div class='row'>
                          <div class='col-sm-2'><b>Prescription Details:</b></div>
                          <div class='col-sm-10'>{{$order->pres_details}}</div>
                      </div>
                    ...
                    @if(Auth::guard('frontpharmacy')->user())  
                      <br>  
                    <div class="row">
                      <div class='col-sm-2'><b>pharmist Comments::</b></div>
                      ...
                      <span id='dcomments_msg' style='color:green;'></span>
                        ...
                        <button id='dcomments_btn'>Save pharmacy Comments</button>
                      </div>
                    </div>
                  ...
                  <br>        
                      @if($order->dcomments !='')
                        <div class='row'>
                          <div class='col-sm-2'><b>Parmist's Comments:</b></div>
...
<script>
  $(document).on('click', '#dcomments_btn', function(){
      ...
      $.ajax({
        type:'post',
        url:"{{url('frontpharmacy/updatePharmacyComments')}}",
        data:{order_id:order_id,dcomments:dcomments,_token: "{{ csrf_token() }}"},
        dataType:'JSON',
        success:function(data){
          console.log('success pharmacys comments');
          console.log(data);
