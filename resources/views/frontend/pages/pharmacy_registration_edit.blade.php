  ...
  <div class="main-content">
    ...
    <div class="container">
	      ...
	      <div class="section-header heading_style4 center">
            <h2>Edit Pharmacy Registration</h2>
            @if (Session::has('message'))
                    ...
                    @endif
                                ...
                                <form id="addPharmacy" action="{{ url('frontpharmacy/editPharmacyRegistrationProcess') }}" method="POST"
                                enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <input type="hidden" name="id" value="{{$pharmacys->id}}" />
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label class="form-label">Full Name</label> <span id='pharmacy_fullname'></span>
                                            <input type="text" name="pharmacy_fullname" value="{{ $pharmacys->pharmacy_fullname }}" id="pharmacy_fullname"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" value="{{ $pharmacys->email }}"  id="email" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="pharmacy_phone" value="{{ $pharmacys->pharmacy_phone }}" id="pharmacy_phone"
                                                class="form-control">
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <input type="hidden" name="pharmacy_status" value="Active" class="form-control">
                                   
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label class="form-label">Country</label> <span id='pharmacy_country'></span>
                                            <input type="text" name="pharmacy_country" value="{{ $pharmacys->pharmacy_country }}" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="pharmacy_city" value="{{ $pharmacys->pharmacy_city }}" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label class="form-label">State</label> <span id='pharmacy_state'></span>
                                            <input type="text" name="pharmacy_state" value="{{ $pharmacys->pharmacy_state }}" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label class="form-label">Address</label> <span id='pharmacy_address'></span>
                                            <input type="text" name="pharmacy_address" value="{{ $pharmacys->pharmacy_address }}" class="form-control">
                                        </div>
                                    </div>
