            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0);">Add Hakeem</a></li>
                    </ol>
            ...
            <div class="row">
                <div class="col-xl-12 col-xxl-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="addHakeem" action="{{ route('admin.hakeemstore') }}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="hakeem_fullname" id="hakeem_fullname"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="hakeem_phone" id="hakeem_phone"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="hakeem_dob" id="hakeem_dob" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="hakeem_degree" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="hakeem_experience" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="hakeem_status">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="hakeem_country" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="hakeem_city" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            <label class="form-label">State</label> <span id='hakeem_state'></span>
                                            <input type="text" name="hakeem_state" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            <label class="form-label">Address</label> <span id='hakeem_address'></span>
                                            <input type="text" name="hakeem_address" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            <label class="form-label">Fees</label> <span id='hakeem_fees'></span>
                                            <input type="text" name="hakeem_fees" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="form-group">
                                            <label class="form-label">Details</label> <span id='hakeem_details'></span>
                                            <textarea name="hakeem_details" rows=7 class="form-control"></textarea>
                                        </div>
                                    </div>
                    ...
                    ?>
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <label class="form-label">Hakeem's Timming:</label> <span id='hakeem_city'></span>
                    </div>
