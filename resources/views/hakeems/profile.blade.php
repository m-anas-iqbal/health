            ...
            <div class="row page-titles mx-0">
                <div class="col-sm-6 p-md-0">
                    <div class="welcome-text">
                        <h4>Hakeem Profile</h4>
                    </div>
                </div>
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    @if (Auth::guard()->user()->role == 12)
                        <a href="{{ route('admin.hakeemedit', $hakeems->id) }}" class="btn btn-primary"> <i
                                class="la la-pencil"></i> Update</a>
                    @endif
                    @if (Auth::guard()->user()->role == 1)
                    <a href="{{ route('hakeem.hakeemedit', $hakeems->id) }}" class="btn btn-primary"> <i
                            class="la la-pencil"></i> Update</a>
                @endif
                </div>
            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="text-center p-3 overlay-box" style="background-image: url();">
                                    ...
                                    <h3 class="mt-3 mb-1 text-white">{{ $hakeems->hakeem_fullname }}</h3>
                                </div>
                                ...
                                <div class="card-body pb-0">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item d-flex px-0 justify-content-between">
                                            ...
                                            <span class="mb-0">
                                                @if ($hakeems->hakeem_dob != null)
                                                    {{ date('d F Y', strtotime($hakeems->hakeem_dob)) }}
                                                @endif
                                            </span>
                                        </li>
                                        ...
                                        <li class="list-group-item d-flex px-0 justify-content-between">
                                            ...
                                            <span class="mb-0">{{ $hakeems->hakeem_gender }}</span>
                                        </li>
                                        <li class="list-group-item d-flex px-0 justify-content-between">
                                            <strong>Education</strong>
                                            <span class="mb-0">{{ $hakeems->hakeem_degree }}</span>
                                        </li>

                                        <li class="list-group-item d-flex px-0 justify-content-between">
                                            <strong>Experience</strong>
                                            <span class="mb-0">{{ $hakeems->hakeem_experience }}</span>
                                        </li>
                                ...
                                <div class="card-body pb-0">
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item d-flex px-0 justify-content-between">
                                            ...
                                            <span class="mb-0">{{ $hakeems->hakeem_country }}</span>
                                        </li>
                                        <li class="list-group-item d-flex px-0 justify-content-between">
                                            <strong>City</strong>
                                            <span class="mb-0">{{ $hakeems->hakeem_city }}</span>
                                        </li>
                                        <li class="list-group-item d-flex px-0 justify-content-between">
                                            <strong>State</strong>
                                            <span class="mb-0">{{ $hakeems->hakeem_state }}</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                            ...
                                            <div class="profile-personal-info pt-4">
                                                ...
                                                <div class="row mb-4">
                                                    ...
                                                    <div class="col-lg-9 col-md-8 col-sm-6 col-6">
                                                        <span>{{ $hakeems->hakeem_fullname }}</span>
                                                    </div>
                                                </div>
                                                <div class="row mb-4">
                                                    <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                                ...
                                                <div class="row mb-4">
                                                    ...
                                                    <div class="col-lg-9 col-md-8 col-sm-6 col-6">
                                                        <span>{{ $hakeems->hakeem_martialStatus }}</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-4">
                                                    ...
                                                    <div class="col-lg-9 col-md-8 col-sm-6 col-6">
                                                        <span>+92 {{ $hakeems->hakeem_phone }}</span>
                                                    </div>
                                                </div>
                                                <div class="row mb-4">
                                                    <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                                        <h5 class="f-w-500">Hakeem Type <span
                                                                class="pull-right">:</span></h5>
                                                    </div>
                                                    <div class="col-lg-9 col-md-8 col-sm-6 col-6">
                                                        <span>
                                                            @if (!empty($hakeemTypes))
                                                                @foreach ($hakeemTypes as $hakeemType)
                                                                    @if ($hakeemType->id == $hakeems->hakeem_hakeemType_id)
                                                                        {{ $hakeemType->hakeemType_name }}
                                                                    @endif
                                                                @endforeach
                                                            @endif
                                                        </span>
                                            ...
                                            <div class="profile-skills pt-2 border-bottom-1 pb-2">
                                                ...
                                                @if (!empty($courseforms))
                                                    @foreach ($courseforms as $courseform)
                                                        @if (in_array($courseform->id, $hakeemcourseForm))
                                            ...
                                            <div class="profile-skills pt-2 border-bottom-1 pb-2">
                                                ...
                                                @if (!empty($hospitals))
                                                    @foreach ($hospitals as $hospital)
                                                        @if (in_array($hospital->id, $hakeemhospital))
                                                            <a href="javascript:void()"
