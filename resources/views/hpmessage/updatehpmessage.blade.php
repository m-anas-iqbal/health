                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                      ...
                                      <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="sort_1" id="sort_1" value="{{ $hpmessages->sort1 }}" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="sort_2" id="sort_2" value="{{ $hpmessages->sort2 }}" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                     ...
                                     <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="form-group">
                                            <label class="form-label">Sort3</label>
                                            <input type="text" name="sort_3" id="sort_3" value="{{ $hpmessages->sort3 }}" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select name="status" class="form-control">
                                                <option value='1' <?php if($hpmessages->status == '1') echo ' selected'; ?>>Active</value>
                                                <option value='0' <?php if($hpmessages->status == '0') echo ' selected'; ?>>Disabled</value>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select name="show_on_hp" class="form-control">
                                                <option value='1' <?php if($hpmessages->show_on_hp == '1') echo ' selected'; ?>>Showed on Home Page</value>
                                                <option value='0' <?php if($hpmessages->show_on_hp == '0') echo ' selected'; ?>>Not Show on Home Page</value>
                                            </select>
                                        </div>
                                    </div>
