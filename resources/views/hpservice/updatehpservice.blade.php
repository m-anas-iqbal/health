                                ...
                                <div class="row">
                                     ...
                                     <div class="col-lg-6 col-md-6 col-sm-12">
                                      ...
                                      <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="sort_1" id="sort_1" class="form-control" value="{{ $hpservices->sort1}}">
                                        </div>
                                    </div>
                                     ...
                                     <div class="col-lg-6 col-md-6 col-sm-12">
                                      ...
                                      <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="sort_2" id="sort_2" class="form-control" value="{{ $hpservices->sort2}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="sort_3" id="sort_3" class="form-control" value="{{ $hpservices->sort3}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                     ...
                                     <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="sort_4" id="sort_4" class="form-control" value="{{ $hpservices->sort4}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                     ...
                                     <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="sort_5" id="sort_5" class="form-control" value="{{ $hpservices->sort5}}">
                                        </div>
                                    </div>
                                   ...
                                   <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="sort_6" id="sort_6" class="form-control" value="{{ $hpservices->sort6}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select name="status" class="form-control">
                                                <option value='1' <?php if($hpservices->status == '1') echo ' selected'; ?>>Active</value>
                                                <option value='0' <?php if($hpservices->status == '0') echo ' selected'; ?>>Disabled</value>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select name="show_on_hp" class="form-control">
                                                <option value='1' <?php if($hpservices->show_on_hp == '1') echo ' selected'; ?>>Showed on Home Page</value>
                                                <option value='0' <?php if($hpservices->show_on_hp == '0') echo ' selected'; ?>>Not Show on Home Page</value>
                                            </select>
                                        </div>
                                    </div>
