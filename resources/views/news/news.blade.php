            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0);">All newss</a></li>
                    </ol>
                </div>
            </div>
                        ...
                        <div id="list-view" class="tab-pane fade active show col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">All news List </h4>
                                    <a href="{{ route('admin.newscreate') }}" class="btn btn-primary">+ Add new</a>
                                </div>
                                <div class="card-body">
                                                ...
                                                @if (!empty($newss))
                                                    @foreach ($newss as $key => $news)
                                                        <tr id="res_{{ $news->id }}">
                                                            ...
                                                            <td>{{ $news->status }}</td>
                                                            <td>
                                                                <a href="{{ route('admin.newsview' , $news->id) }}"
                                                                    class="btn btn-sm btn-warning">
                                                                    <i class="la la-eye"></i>
                                                                </a>
                                                                <a href="{{ route('admin.newsedit' , $news->id) }}"
