            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0);">Add Nurse</a></li>
                    </ol>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12 col-xxl-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="addNurse" action="{{ route('admin.nursestore') }}" method="POST">
                                {{ csrf_field() }}
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nurse_address" id="nurse_address"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="nurse_phone" id="nurse_phone" class="form-control">
                                        </div>
                                    </div>
    ...
    <script>
        $("#addNurse").validate({
            ...
            messages: {
                ...
                nurse_gender: '<span class="text-danger ">Gender is Required</span>',
