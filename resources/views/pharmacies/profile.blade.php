            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    @if (Auth::guard()->user()->role == 12)
                        <a href="{{ route('admin.pharmacyedit', $pharmacys->id) }}" class="btn btn-primary"> <i
                                class="la la-pencil"></i> Update</a>
                    @endif
                    @if (Auth::guard()->user()->role == 1)
                    <a href="{{ route('pharmacy.pharmacyedit', $pharmacys->id) }}" class="btn btn-primary"> <i
                            class="la la-pencil"></i> Update</a>
                @endif
                </div>
            </div>
                            ...
                            <div class="card">
                                <div class="text-center p-3 overlay-box" style="background-image: url();">
                                    <div class="profile-photo">
                                        <img src="{{ asset('uploads/PharmacyImagesSave/' . $pharmacys->pharmacy_profileImage) }}"
                                            width="100" class="img-fluid rounded-circle" alt="">
                                    </div>
                                    <h3 class="mt-3 mb-1 text-white">{{ $pharmacys->pharmacy_fullname }}</h3>
                                </div>
                                ...
                                <div class="card-body pb-0">
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item d-flex px-0 justify-content-between">
                                            ...
                                            <span class="mb-0">{{ $pharmacys->pharmacy_country }}</span>
                                        </li>
                                        <li class="list-group-item d-flex px-0 justify-content-between">
                                            <strong>City</strong>
                                            <span class="mb-0">{{ $pharmacys->pharmacy_city }}</span>
                                        </li>
                                        <li class="list-group-item d-flex px-0 justify-content-between">
                                            <strong>State</strong>
                                            <span class="mb-0">{{ $pharmacys->pharmacy_state }}</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                            ...
                                            <div class="profile-personal-info pt-4">
                                                ...
                                                <div class="row mb-4">
                                                    ...
                                                    <div class="col-lg-9 col-md-8 col-sm-6 col-6">
                                                        <span>{{ $pharmacys->pharmacy_fullname }}</span>
                                                    </div>
                                                </div>
                                                <div class="row mb-4">
                                                    <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                                ...
                                                <div class="row mb-4">
                                                    ...
                                                    <div class="col-lg-9 col-md-8 col-sm-6 col-6">
                                                        <span>+92 {{ $pharmacys->pharmacy_phone }}</span>
                                                    </div>
                                                </div>
                                                <div class="row mb-4">
                                                    <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                                        <h5 class="f-w-500">Pharmacy Type <span
                                                                class="pull-right">:</span></h5>
                                                    </div>
                                                    <div class="col-lg-9 col-md-8 col-sm-6 col-6">
                                                        <span>
                                                            @if (!empty($pharmacyTypes))
                                                                @foreach ($pharmacyTypes as $pharmacyType)
                                                                    @if ($pharmacyType->id == $pharmacys->pharmacy_pharmacyType_id)
                                                                        {{ $pharmacyType->pharmacyType_name }}
                                                                    @endif
                                                                @endforeach
                                                            @endif
                                                        </span>
