            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0);">View Testimonial</a></li>
                    </ol>
                </div>
            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <h4>name : <strong> {{ $testimonials->name }}</strong> </h4>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <h4>Image</h4><br>
                                        <img src="{{ asset('public/uploads/testimonialImage/' . $testimonials->image) }}" width="350" alt="">
                                    </div>
                                </div>
